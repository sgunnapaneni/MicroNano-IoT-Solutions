    ...
    <section>
      ...
      <div className="team-container">
        <div className="team-member">
          <img src={venkatImage} alt="Sai Venkat Kumar Gunnapaneni" className="team-photo" />
        ...
        <div className="team-member">
          <img src={alexImage} alt="Alex Chilaka" className="team-photo" />
          <h4>Alex Chilaka</h4>
          <p>Lead Architect</p>
        ...
        <div className="team-member">
          <img src={rakeshImage} alt="Rakesh Reddy Dodda" className="team-photo" />
        ...
        <div className="team-member">
          <img src={paramImage} alt="Param Sangani" className="team-photo" />
          <h4>Param Sangani</h4>
        ...
        <div className="team-member">
          <img src={ramyaImage} alt="Sai Ramya Valleru" className="team-photo" />

...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/saivenkatkumargunnapaneni/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20d201246b26031fc94872URwJBBwEDFFXBwEFCQRUDAZeUQBT', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/saivenkatkumargunnapaneni/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20d201246b26031fc94872URwJBBwEDFFXBwEFCQRUDAZeUQBT', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
